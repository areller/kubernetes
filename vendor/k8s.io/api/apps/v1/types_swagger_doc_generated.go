...
var map_StatefulSetStatus = map[string]string{
	...
	"volumeClaimTemplates": "The status of the volume claim templates in the statefulset.",
}
...
var map_VolumeClaimTemplateStatus = map[string]string{
	"templateName":                     "the name of the late that this status pertains to",
	"finishedReconciliationGeneration": "the last generation where all claims of this template were fully reconciled with the storage driver.",
	"readyReplicas":                    "the number of replicas for which this template is fully reconciled with the storage driver.",
}

func (VolumeClaimTemplateStatus) SwaggerDoc() map[string]string {
	return map_VolumeClaimTemplateStatus
}
