...
type StatefulSetStatusApplyConfiguration struct {
	...
	VolumeClaimTemplates []VolumeClaimTemplateStatusApplyConfiguration `json:"volumeClaimTemplates,omitempty"`
}
...
func (b *StatefulSetStatusApplyConfiguration) WithVolumeClaimTemplates(values ...*VolumeClaimTemplateStatusApplyConfiguration) *StatefulSetStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {
